...
- Preview transcription is mandatory and must use the same canonical local WhisperX/Community-1 contract. Missing, non-forced-aligned, non-diarized, or zero timed-word coverage is blocking.
