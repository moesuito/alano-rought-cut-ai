...
| CUT-01, CUT-02, CUT-03 | F1.5 | pending |
| CUT-02, CUT-03 | F1.6 | pending |
...
6. F1.6 — adaptive lexical/acoustic entry selection and join-centric audio/transcript QC.
...
F1.5 repairs the fail-open contracts first. F1.6 then repairs adaptive join selection and validates the real regression without introducing a global fixed trim or fixed pre-roll.
